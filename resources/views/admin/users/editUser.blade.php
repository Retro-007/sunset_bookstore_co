                                ...
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="fs-2 fw-bolder " data-kt-countup="true"
                                            data-kt-countup-value="0">0
                                        </div>
                                    </div>
                                    <!--end::Number-->
                                    <!--begin::Label-->
                                    <div class="fw-bold fs-6 text-gray-400">Order value</div>
                                    <!--end::Label-->
                                </div>
                                <!--end::Stat-->
                                <!--begin::Stat-->
                ...
                <div class="card-header  card-header-stretch">
                    <div class="card-toolbar">
                        <ul class="nav nav-tabs nav-pills border-0 flex-row flex-md-row me-5 mb-3 mb-md-0 fs-6">
                            ...
                            {{-- <li class="nav-item w-md-100px">
                                <a class="nav-link" data-bs-toggle="tab" href="#kt_vtab_pane_6">Wallet</a>
                            </li>
                            <li class="nav-item w-md-200px">
                                <a class="nav-link" data-bs-toggle="tab" href="#kt_vtab_pane_8">Brandko Coin</a>
                            </li>

                            <li class="nav-item w-md-200px">
                                <a class="nav-link" data-bs-toggle="tab" href="#kt_vtab_pane_7">Refer And Earn</a>
                            </li> --}}
                            ...
                            <div id="kt_account_settings_profile_details" class="collapse show">
                                ...
                                <form class="form fv-plugins-bootstrap5 fv-plugins-framework"
                                    ...
                                    <div class="card-body border-top p-9">
                                        <div class="row mb-6">
                                            <!--begin::Label-->
                                            <label class="col-lg-4 col-form-label required fw-bold fs-6">Change
                                                Password</label>
                                            <!--end::Label-->
                                            <!--begin::Col-->
                                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
